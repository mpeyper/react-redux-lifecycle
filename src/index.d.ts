...
interface LifecycleActions {
  ...
  componentDidCatch?: Actionable | Array<Actionable>
}

interface ComponentDecorator {
  <TProps, TComponentConstruct extends React.ComponentClass<TProps> | React.StatelessComponent<TProps>>(
...
export function onComponentDidCatch(action: Actionable): ComponentDecorator
